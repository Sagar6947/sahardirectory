												...
												<div class="Goodup-grid-wrap">
													<div class="Goodup-grid-upper">
														...
														<div class="Goodup-grid-thumb">
															<a href="<?= base_url() ?>listing/<?= url_title($row['company_city']) ?>/<?= url_title(strtolower($cate[0]['category'])); ?>/<?= url_title($row['company_name']) ?>/<?= encryptId($row['company_id']) ?>" class="d-block text-center m-auto"><img src="uploads/company/<?= $row['company_banner'] ?>" class="img-fluid" alt=""></a>
														</div>

													</div>
													<div class="Goodup-grid-fl-wrap">
														<div class="Goodup-caption px-3 py-2">
															<div class="Goodup-author"><a href="author-detail.html"><img src="uploads/company/<?= $row['company_logo'] ?>" class="img-fluid circle" alt=""></a></div>
															<div class="Goodup-cates multi"><a href="" class="cats-1"><?= $cate[0]['category'] ?></a><a href="" class="cats-2"><?= $sub_tag[0]['subcategory'] ?></a></div>
															<h4 class="mb-0 ft-medium medium"><a href="<?= base_url() ?>listing/<?= url_title($row['company_city']) ?>/<?= url_title(strtolower($cate[0]['category'])); ?>/<?= url_title($row['company_name']) ?>/<?= encryptId($row['company_id']) ?>" class="text-dark fs-md"><?php echo $row['company_name']; ?></a></h4>
														...
														<div class="Goodup-grid-footer py-2 px-3">
															<div class="Goodup-ft-first">
																<a href="<?= base_url() ?>listing/<?= url_title($row['company_city']) ?>/<?= url_title(strtolower($cate[0]['category'])); ?>/<?= url_title($row['company_name']) ?>/<?= encryptId($row['company_id']) ?>" class="Goodup-cats-wrap">
