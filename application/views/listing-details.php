...
background-size: cover;">
        ...
        ?>
            <div class="abs-list-sec right_pos"><a href="<?= base_url() ?>sahar/<?= url_title($row[0]['company_city']) ?>/<?= url_title(strtolower($cate[0]['category'])); ?>/<?= $row[0]['company_web_title'] ?>" class="add-list-btn" target="_blank"><i class="fas fa-id-card me-2"></i>Company Website</a></div>
        <?php
        }
        ?>
        <div class="container">
