                                                ...
                                                <ul class="no-ul-list filter-list category-list">
                                                    ...
                                                    ?>
                                                            <li>
                                                                ...
                                                                <ul class="subcate_ul subcate_ul<?= $i ?>">
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <li>
                                                                                <input id="<?= $j ?>" value="<?= $subcat_row['subcat_id'] ?>" class="common_selector checkbox-custom subcategory" type="checkbox">
                                                                                <label for="<?= $j ?>" class="checkbox-custom-label"><?= $subcat_row['subcategory'] ?> </label>
                                                                            </li>
                                                                    <?php
                                                                        }
                                                                    }
