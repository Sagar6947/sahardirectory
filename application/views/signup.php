                                ...
                                <div class="form-group">
											<div class="d-flex align-items-center justify-content-between">
												<div class="" style="width: 100%">
													...
													<label for="dd" class="checkbox-custom-label">By clicking Sign Up, you agree to our <a target="_blank" href="<?= base_url('term-condition') ?>" style="color: #f41b3b; text-decoration: underline;">Terms & Condition</a> and <a target="_blank" href="<?= base_url('privacy-policy') ?>" style="color: #f41b3b; text-decoration: underline;">Privac Policy.</a> You may receive SMS notifications from us.</label>
												</div>
											</div>
										</div>
