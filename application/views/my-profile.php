												...
												<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
													<div class="form-group sagar">
														...
														if ($datacomrow != '') {	?>
															...
															<select name="company_subcategory" class="form-control" data-live-search="true">

																<?php
																$subcate = getAllRowInOrder('company_subcategory', 'subcategory', 'ASC');
											...
											<div class="row">
												<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
													<div class="form-group sagar">
														...
														<select class="form-control" data-live-search="true" name="company_state" id="state" required>
												...
												<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
													<div class="form-group sagar">
														...
														<?php if ($datacomrow != '') {	?>
															...
															<select name="company_city" class="form-control" id="city" data-live-search="true" required>
